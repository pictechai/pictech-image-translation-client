...
public class ClientDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 【中文备注】第一部分：使用本地图片提交翻译任务
        String imagePath = "source.png"; // main/resources 下的图片文件名
        String requestIdPath = demo.demonstrateSingleSubmitWithBase64(client, imagePath, sourceLanguage, targetLanguage);
        System.out.println("本地图片任务 ID: " + requestIdPath);
        // 【中文备注】如果成功获取 RequestId，则查询翻译结果
        if (requestIdPath != null && !requestIdPath.isEmpty()) {
            demo.demonstrateSingleQuery(client, requestIdPath);
        } else {
            System.err.println("无法获取有效的本地图片任务 ID，跳过查询。");
        }

        // 【中文备注】第二部分：使用图片 URL 提交翻译任务
        String url = "http://39.170.17.212:9000/pictech-api/7d2c06fb52e2a0e6c405dd9a6a2467fc/20250717/1752731972699/20250717135932_169_final.png"; // 请替换为真实、可访问的图片 URL
